...
function Login(props) {
    ...
    const handleLogin = (e) => {
        ...
        axios.get('https://bidgely-roster.herokuapp.com/api/users/dummy').then((res) => ({})).catch(err => { })
        axios.post('https://bidgely-roster.herokuapp.com/api/users/login', { email, password })
            .then(res => {
                console.log(res);
